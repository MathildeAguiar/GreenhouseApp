package fr.uga.polytech.greenhouse.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, fr.uga.polytech.greenhouse.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, fr.uga.polytech.greenhouse.repository.UserRepository.USERS_BY_EMAIL_CACHE);
