...
import fr.uga.polytech.greenhouse.service.AlertQueryService;
...
/**
 * REST controller for managing {@link fr.uga.polytech.greenhouse.domain.Alert}.
 */
@RestController
@RequestMapping("/api")
public class AlertResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/alerts/{id}", consumes = "application/merge-patch+json")
