...
import fr.uga.polytech.greenhouse.service.TaskQueryService;
import fr.uga.polytech.greenhouse.service.TaskService;
...
/**
 * REST controller for managing {@link fr.uga.polytech.greenhouse.domain.Task}.
 */
@RestController
@RequestMapping("/api")
