...
describe('Component Tests', () => {
  describe('GreenHouse Management Component', () => {
    let comp: GreenHouseComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(GreenHouseComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.greenHouses?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
